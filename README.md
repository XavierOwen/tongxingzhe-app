...
- Drift v5 基线、v6／v7／v8 中间版本、当前 v9 schema 快照和 v5／v6／v8→v9 升级测试；
...
Drift 当前 v9 快照和 v5／v6／v8→v9 升级检查：
