...
const Map<String, Map<String, String>> _strings = {
  'zh': {
    ...
    'originalRegionReportTitle': '原始区域报告',
    'originalRegionReportIntro': '选择已发布的两期原始区域报告。只显示服务端已保护的结果。',
    'originalRegionReportDirectoryTitle': '原始区域快照目录',
    'originalRegionReportDirectoryEmpty': '当前项目没有可读取的原始区域报告快照。',
    'originalRegionReportDirectoryLoading': '正在载入原始区域报告目录',
    'originalRegionReportLoading': '正在载入原始区域报告',
    'originalRegionReportRetry': '重试',
    'originalRegionReportBackToDirectory': '返回原始区域快照目录',
    'originalRegionReportUnauthorized': '当前账号没有读取原始区域报告的权限。',
    'originalRegionReportForbidden': '当前账号不能读取这个管理项目的原始区域报告。',
    'originalRegionReportNotFound': '这个原始区域报告快照已不存在。',
    'originalRegionReportInvalidRequest': '原始区域报告请求未被服务接受。请重新打开后再试。',
    'originalRegionReportNetworkUnavailable': '无法连接原始区域报告服务，请检查网络后重试。',
    'originalRegionReportUntrusted': '原始区域报告来源无法验证。',
    'originalRegionReportServiceUnavailable': '原始区域报告服务暂时不可用，请稍后重试。',
    'originalRegionReportInvalidResponse': '原始区域报告服务返回了无效结果。',
    'originalRegionReportNotConfigured': '原始区域报告服务尚未配置。',
    'originalRegionReportFailed': '原始区域报告暂时无法载入，请重试。',
    'originalRegionReportVersion': '报告版本',
    'originalRegionReportDefinition': '报告定义',
    'originalRegionReportMetric': '统计指标',
    'originalRegionReportDimension': '维度',
    'originalRegionReportViewMode': '视图模式',
    'originalRegionReportRegionGranularity': '区域粒度',
    'originalRegionReportQueryFingerprint': '查询指纹',
    'originalRegionReportSourceScope': '数据来源',
    'originalRegionReportPrivacyRule': '隐私规则',
    'originalRegionReportProject': '管理项目',
    'originalRegionReportTimeZone': '报告时区',
    'originalRegionReportDataCutoff': '数据截止',
    'originalRegionReportReleasedAt': '发布时间',
    'originalRegionReportPeriodBoundary': '期间边界',
    'originalRegionReportPreviousPeriod': '较早期间',
    'originalRegionReportCurrentPeriod': '较晚期间',
    'originalRegionReportSourceTreeContext': '来源树上下文',
    'originalRegionReportSourceTreeContract': '来源树合同',
    'originalRegionReportSourceTreeResult': '来源树状态',
    'originalRegionReportSourceTreeReason': '来源树原因',
    'originalRegionReportSourceTreeVersion': '来源树版本',
    'originalRegionReportSourceTreeFingerprint': '来源树内容指纹',
    'originalRegionReportSourceChangeSequence': '来源变化序号',
    'originalRegionReportResultStatus': '报告状态',
    'originalRegionReportCellsTitle': '城市格',
    'originalRegionReportCityId': '城市 ID',
    'originalRegionReportDisplayedCount': '显示格数',
    'originalRegionReportSuppressedCount': '隐藏格数',
    'originalRegionReportSuppressed': '已隐藏',
    'originalRegionReportDisplayedValue': '{value} 次',
    'originalRegionReportCellSemantics': '{period}，城市 ID {cityId}：{value}',
  ...
  'en': {
    ...
    'currentCityReportPeriodSemantics':
        '{period}: {from} to {until}, excluding the end time',
    'originalRegionReportTitle': 'Original-region reports',
    'originalRegionReportIntro':
        'Choose a published original-region report with two periods. The service protects the values shown here.',
    'originalRegionReportDirectoryTitle': 'Original-region snapshot directory',
    'originalRegionReportDirectoryEmpty':
        'This project has no original-region report snapshots to read.',
    'originalRegionReportDirectoryLoading':
        'Loading the original-region report directory',
    'originalRegionReportLoading': 'Loading the original-region report',
    'originalRegionReportRetry': 'Retry',
    'originalRegionReportBackToDirectory':
        'Back to the original-region snapshot directory',
    'originalRegionReportUnauthorized':
        'This account cannot read original-region reports.',
    'originalRegionReportForbidden':
        'This account cannot read original-region reports for this management project.',
    'originalRegionReportNotFound':
        'This original-region report snapshot no longer exists.',
    'originalRegionReportInvalidRequest':
        'The original-region report request was not accepted. Open the report again and retry.',
    'originalRegionReportNetworkUnavailable':
        'The original-region report service is unreachable. Check the network and retry.',
    'originalRegionReportUntrusted':
        'The original-region report source could not be verified.',
    'originalRegionReportServiceUnavailable':
        'The original-region report service is temporarily unavailable. Retry later.',
    'originalRegionReportInvalidResponse':
        'The original-region report service returned an invalid response.',
    'originalRegionReportNotConfigured':
        'The original-region report service is not configured.',
    'originalRegionReportFailed':
        'The original-region report could not load. Retry the request.',
    'originalRegionReportVersion': 'Report version',
    'originalRegionReportDefinition': 'Report definition',
    'originalRegionReportMetric': 'Metric',
    'originalRegionReportDimension': 'Dimension',
    'originalRegionReportViewMode': 'View mode',
    'originalRegionReportRegionGranularity': 'Region granularity',
    'originalRegionReportQueryFingerprint': 'Query fingerprint',
    'originalRegionReportSourceScope': 'Data source',
    'originalRegionReportPrivacyRule': 'Privacy rule',
    'originalRegionReportProject': 'Management project',
    'originalRegionReportTimeZone': 'Report time zone',
    'originalRegionReportDataCutoff': 'Data cutoff',
    'originalRegionReportReleasedAt': 'Published at',
    'originalRegionReportPeriodBoundary': 'Period boundary',
    'originalRegionReportPreviousPeriod': 'Earlier period',
    'originalRegionReportCurrentPeriod': 'Later period',
    'originalRegionReportSourceTreeContext': 'Source-tree context',
    'originalRegionReportSourceTreeContract': 'Source-tree contract',
    'originalRegionReportSourceTreeResult': 'Source-tree status',
    'originalRegionReportSourceTreeReason': 'Source-tree reason',
    'originalRegionReportSourceTreeVersion': 'Source-tree version',
    'originalRegionReportSourceTreeFingerprint': 'Source-tree fingerprint',
    'originalRegionReportSourceChangeSequence': 'Source change sequence',
    'originalRegionReportResultStatus': 'Report status',
    'originalRegionReportCellsTitle': 'City cells',
    'originalRegionReportCityId': 'City ID',
    'originalRegionReportDisplayedCount': 'Displayed cells',
    'originalRegionReportSuppressedCount': 'Hidden cells',
    'originalRegionReportSuppressed': 'Hidden',
    'originalRegionReportDisplayedValue': '{value} sessions',
    'originalRegionReportCellSemantics': '{period}, city ID {cityId}: {value}',
    'originalRegionReportPeriodSemantics':
        '{period}: {from} to {until}, excluding the end time',
    'originalRegionReportOpenSemantics':
