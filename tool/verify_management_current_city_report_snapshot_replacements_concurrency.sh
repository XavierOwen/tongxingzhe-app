...
# Two independent sessions exercise the 6CB current-city lineage lock and
...
release_claim_first_pid=''
release_claim_replacement_pid=''
replacement_claim_first_pid=''
...
cleanup() {
  for pid in \
    ...
    "${revoke_first_pid}" "${revoke_replacement_pid}" \
    "${release_claim_first_pid}" "${release_claim_replacement_pid}" \
    "${replacement_claim_first_pid}" "${replacement_claim_release_pid}"; do
...
lineage_prefix='management-current-city-snapshot-replacement-lineage'
replacement_project='6cbc3000-0000-4000-8000-000000000001'
replacement_workspace='6cbc2000-0000-4000-8000-000000000001'
replacement_user_one='6cbc1000-0000-4000-8000-000000000001'
replacement_user_two='6cbc1000-0000-4000-8000-000000000002'
replacement_capability_one='6cbc6000-0000-4000-8000-000000000001'
replacement_capability_two='6cbc6000-0000-4000-8000-000000000002'
lineage_lock_name="${lineage_prefix}:${replacement_project}:management-region-report:contact_sessions_by_current_city_two_periods"
...
echo '建立 6CB-concurrency synthetic current-city snapshots。'
run_psql <<'SQL'
BEGIN;

INSERT INTO app_data.app_users (app_user_id, status) VALUES
  ('6cbc1000-0000-4000-8000-000000000001'::uuid, 'active'),
  ('6cbc1000-0000-4000-8000-000000000002'::uuid, 'active');

INSERT INTO app_data.workspaces (
  workspace_id, workspace_kind, display_name, deleted_at
) VALUES (
  '6cbc2000-0000-4000-8000-000000000001'::uuid,
  'organization', '6CB concurrency organization', NULL
);

INSERT INTO app_data.projects (
  project_id, workspace_id, display_name, status, is_personal_default
) VALUES (
  '6cbc3000-0000-4000-8000-000000000001'::uuid,
  '6cbc2000-0000-4000-8000-000000000001'::uuid,
  '6CB concurrency project', 'active', false
);
...
INSERT INTO app_data.organization_memberships (
  ...
  (
    '6cbc4000-0000-4000-8000-000000000001'::uuid,
    '6cbc2000-0000-4000-8000-000000000001'::uuid,
    '6cbc1000-0000-4000-8000-000000000001'::uuid,
    '2025-01-01T00:00:00Z', NULL
  ),
  (
    '6cbc4000-0000-4000-8000-000000000002'::uuid,
    '6cbc2000-0000-4000-8000-000000000001'::uuid,
    '6cbc1000-0000-4000-8000-000000000002'::uuid,
    '2025-01-01T00:00:00Z', NULL
  );
...
INSERT INTO app_data.organization_owner_assignments (
  ...
  '6cbc7000-0000-4000-8000-000000000001'::uuid,
  '6cbc4000-0000-4000-8000-000000000001'::uuid,
...
INSERT INTO app_data.project_memberships (
  ...
  (
    '6cbc5000-0000-4000-8000-000000000001'::uuid,
    '6cbc4000-0000-4000-8000-000000000001'::uuid,
    '6cbc3000-0000-4000-8000-000000000001'::uuid,
    '2025-01-01T00:00:00Z', NULL
  ),
  (
    '6cbc5000-0000-4000-8000-000000000002'::uuid,
    '6cbc4000-0000-4000-8000-000000000002'::uuid,
    '6cbc3000-0000-4000-8000-000000000001'::uuid,
    '2025-01-01T00:00:00Z', NULL
  );
...
INSERT INTO app_data.management_report_capability_grants (
  ...
  (
    '6cbc6000-0000-4000-8000-000000000001'::uuid,
    '6cbc5000-0000-4000-8000-000000000001'::uuid,
    'release_management_reports', '2025-01-01T00:00:00Z', NULL
  ),
  (
    '6cbc6000-0000-4000-8000-000000000002'::uuid,
    '6cbc5000-0000-4000-8000-000000000002'::uuid,
    'release_management_reports', '2025-01-01T00:00:00Z', NULL
  );
...
INSERT INTO app_private.project_reporting_time_zone_versions (
  ...
  '6cbc3000-0000-4000-8000-000000000001'::uuid,
  1, 0, '6cbc8000-0000-4000-8000-000000000001'::uuid,
  '6cbc1000-0000-4000-8000-000000000001'::uuid, 'UTC',
...
) VALUES ('fixture-6cb-concurrency-v1', 'draft', false, NULL, NULL);
INSERT INTO app_data.canonical_region_versions (
  region_id, tree_version, parent_region_id, canonical_name, kind
) VALUES
  ('fixture-6cbc-country', 'fixture-6cb-concurrency-v1', NULL,
    '6CBC Country', 'country'),
  ('fixture-6cbc-city', 'fixture-6cb-concurrency-v1', 'fixture-6cbc-country',
    '6CBC City', 'city');
INSERT INTO app_data.canonical_region_boundaries (
  boundary_id, region_id, tree_version, boundary
) VALUES (
  'fixture-6cbc-city-boundary', 'fixture-6cbc-city',
  'fixture-6cb-concurrency-v1',
  polygon '((-88.00,41.60),(-87.90,41.60),(-87.90,41.70),(-88.00,41.70))'
);
SELECT app_private.publish_canonical_region_tree_v1(
  'fixture-6cb-concurrency-v1', true
);

-- Build complete current-city report documents.  Every candidate is
...
WITH snapshots(
  ...
  VALUES
    (
      '6cbca000-0000-4000-8000-000000000001'::uuid,
      '6cbcb000-0000-4000-8000-000000000001'::uuid,
      '6cbc1000-0000-4000-8000-000000000001'::uuid,
      '2099-02-05T12:00:00Z'::timestamptz,
      '2099-02-05T13:00:00Z'::timestamptz, NULL::uuid, 1
    ),
    (
      '6cbca000-0000-4000-8000-000000000002'::uuid,
      '6cbcb000-0000-4000-8000-000000000002'::uuid,
      '6cbc1000-0000-4000-8000-000000000001'::uuid,
      '2099-02-06T12:00:00Z'::timestamptz,
      '2099-02-06T13:00:00Z'::timestamptz,
      '6cbca000-0000-4000-8000-000000000001'::uuid, 2
    ),
    (
      '6cbca000-0000-4000-8000-000000000003'::uuid,
      '6cbcb000-0000-4000-8000-000000000003'::uuid,
      '6cbc1000-0000-4000-8000-000000000002'::uuid,
    ...
    (
      '6cbca000-0000-4000-8000-000000000004'::uuid,
      '6cbcb000-0000-4000-8000-000000000004'::uuid,
      '6cbc1000-0000-4000-8000-000000000001'::uuid,
      '2099-03-05T12:00:00Z'::timestamptz,
      '2099-03-05T13:00:00Z'::timestamptz, NULL::uuid, 1
    ),
    (
      '6cbca000-0000-4000-8000-000000000005'::uuid,
      '6cbcb000-0000-4000-8000-000000000005'::uuid,
      '6cbc1000-0000-4000-8000-000000000001'::uuid,
      '2099-03-06T12:00:00Z'::timestamptz,
      '2099-03-06T13:00:00Z'::timestamptz,
      '6cbca000-0000-4000-8000-000000000004'::uuid, 2
    ),
    (
      '6cbca000-0000-4000-8000-000000000006'::uuid,
      '6cbcb000-0000-4000-8000-000000000006'::uuid,
      '6cbc1000-0000-4000-8000-000000000002'::uuid,
      '2099-04-08T12:00:00Z'::timestamptz,
      '2099-04-08T13:00:00Z'::timestamptz, NULL::uuid, 1
    ),
    (
      '6cbca000-0000-4000-8000-000000000007'::uuid,
      '6cbcb000-0000-4000-8000-000000000007'::uuid,
      '6cbc1000-0000-4000-8000-000000000002'::uuid,
      '2099-04-09T12:00:00Z'::timestamptz,
      '2099-04-09T13:00:00Z'::timestamptz,
      '6cbca000-0000-4000-8000-000000000006'::uuid, 2
    )
), reports AS (
  SELECT
    snapshot.*,
    jsonb_build_object(
      ...
      'project_id', '6cbc3000-0000-4000-8000-000000000001',
      ...
      'cells', jsonb_build_array(
        jsonb_build_object(
          'period_key', 'previous', 'city_id', 'fixture-6cbc-city',
          'cell_order', 0, 'value_count', 10, 'privacy_status', 'displayed'
        ),
        jsonb_build_object(
          'period_key', 'current', 'city_id', 'fixture-6cbc-city',
...
WITH snapshots(
  ...
  VALUES
    ...
    ('6cbca000-0000-4000-8000-000000000006'::uuid,
      '6cbcb000-0000-4000-8000-000000000006'::uuid,
      '6cbc1000-0000-4000-8000-000000000002'::uuid,
      '2099-04-08T12:00:00Z'::timestamptz, '2099-04-08T13:00:00Z'::timestamptz,
      NULL::uuid, 1),
    ('6cbca000-0000-4000-8000-000000000007'::uuid,
      '6cbcb000-0000-4000-8000-000000000007'::uuid,
      '6cbc1000-0000-4000-8000-000000000002'::uuid,
      '2099-04-09T12:00:00Z'::timestamptz, '2099-04-09T13:00:00Z'::timestamptz,
      '6cbca000-0000-4000-8000-000000000006'::uuid, 2)
), reports AS (
  SELECT
    snapshot.*,
    jsonb_build_object(
      ...
      'metric_version', 1, 'dimension', 'current_city',
      'view_mode', 'current', 'region_granularity', 'city',
      'query_fingerprint',
        'management-report:contact_sessions_by_current_city_two_periods:v1',
      'privacy_policy', 'management_current_city_contact_session_privacy_v1',
      'source_scope', 'backend_accepted_active_contacts_current_revision',
      ...
      'result_status', 'completed',
      'cells', jsonb_build_array(
        jsonb_build_object('period_key', 'previous', 'city_id', 'fixture-6cbc-city',
          'cell_order', 0, 'value_count', 10, 'privacy_status', 'displayed'),
        jsonb_build_object('period_key', 'current', 'city_id', 'fixture-6cbc-city',
          'cell_order', 1, 'value_count', 10, 'privacy_status', 'displayed')
      )
    ) AS protected_report
  FROM snapshots AS snapshot
...
SELECT
  ...
  'management-report:contact_sessions_by_current_city_two_periods:v1', 'UTC',
  data_cutoff_utc, released_at_utc, previous_snapshot_id,
  source_change_sequence, protected_report
FROM reports;

-- The approved 6AO attempts are enough for the trusted-provenance helper;
...
SELECT format('6cbcb000-0000-4000-8000-00000000000%s', n)::uuid,
...
SELECT
  ...
  CASE WHEN snapshot.release_request_id IN (
    ...
    '6cbcb000-0000-4000-8000-000000000006'::uuid,
    '6cbcb000-0000-4000-8000-000000000007'::uuid
  ) THEN '6cbc1000-0000-4000-8000-000000000002'::uuid
  ELSE '6cbc1000-0000-4000-8000-000000000001'::uuid END,
  '6cbc2000-0000-4000-8000-000000000001'::uuid,
  CASE WHEN snapshot.release_request_id IN (
    '6cbcb000-0000-4000-8000-000000000003'::uuid,
    '6cbcb000-0000-4000-8000-000000000006'::uuid,
    '6cbcb000-0000-4000-8000-000000000007'::uuid
  ) THEN '6cbc4000-0000-4000-8000-000000000002'::uuid
  ELSE '6cbc4000-0000-4000-8000-000000000001'::uuid END,
  CASE WHEN snapshot.release_request_id IN (
    '6cbcb000-0000-4000-8000-000000000003'::uuid,
    '6cbcb000-0000-4000-8000-000000000006'::uuid,
    '6cbcb000-0000-4000-8000-000000000007'::uuid
  ) THEN '6cbc5000-0000-4000-8000-000000000002'::uuid
  ELSE '6cbc5000-0000-4000-8000-000000000001'::uuid END,
  CASE WHEN snapshot.release_request_id IN (
    '6cbcb000-0000-4000-8000-000000000003'::uuid,
    '6cbcb000-0000-4000-8000-000000000006'::uuid,
    '6cbcb000-0000-4000-8000-000000000007'::uuid
  ) THEN '6cbc6000-0000-4000-8000-000000000002'::uuid
  ELSE '6cbc6000-0000-4000-8000-000000000001'::uuid END,
  'release_management_reports', snapshot.data_cutoff_utc,
  '6cbc3000-0000-4000-8000-000000000001'::uuid, 1, 'UTC',
  ...
  (SELECT content_fingerprint
   ...
   WHERE tree_version = 'fixture-6cb-concurrency-v1'),
...
FROM (
  VALUES
    ...
    ('6cbcb000-0000-4000-8000-000000000005'::uuid,
      ...
      '6cbca000-0000-4000-8000-000000000005'::uuid),
    ('6cbcb000-0000-4000-8000-000000000006'::uuid,
      '2099-04-08T12:00:00Z'::timestamptz, NULL::uuid,
      '6cbca000-0000-4000-8000-000000000006'::uuid),
    ('6cbcb000-0000-4000-8000-000000000007'::uuid,
      '2099-04-09T12:00:00Z'::timestamptz,
      '6cbca000-0000-4000-8000-000000000006'::uuid,
...
race_ready_lock='6cb-concurrency-race-ready'
...
run_psql --quiet --command="
  ...
  SELECT app_private.declare_management_current_city_snapshot_replacement_v1(
    '6cbcd000-0000-4000-8000-000000000001'::uuid,
    '${replacement_user_one}'::uuid, '${replacement_project}'::uuid,
    '6cbca000-0000-4000-8000-000000000001'::uuid,
    '6cbca000-0000-4000-8000-000000000002'::uuid, 'contact_revision'
  );
...
run_psql --quiet --command="
  SELECT app_private.declare_management_current_city_snapshot_replacement_v1(
    '6cbcd000-0000-4000-8000-000000000002'::uuid,
    '${replacement_user_two}'::uuid, '${replacement_project}'::uuid,
    '6cbca000-0000-4000-8000-000000000001'::uuid,
    '6cbca000-0000-4000-8000-000000000003'::uuid, 'late_accepted_data'
  );
...
if [[ "${race_first_status}" -ne 0 || "${race_second_status}" -eq 0 ]]; then
  echo "同一 current-city active head 并发 replacement 结果错误：first=${race_first_status}, second=${race_second_status}" >&2
...
if ! grep -Eqi 'active head|stale|already.*replacement' "${race_second_output}"; then
  echo '第二个 current-city replacement 没有以 stale active head 失败关闭。' >&2
  sed -n '1,160p' "${race_second_output}" >&2
  exit 1
fi
...
race_state="$(run_psql --tuples-only --no-align --field-separator='|' --command="
  SELECT count(*)::text,
    count(*) FILTER (WHERE replacement_request_id =
      '6cbcd000-0000-4000-8000-000000000001'::uuid)::text,
    count(*) FILTER (WHERE replacement_request_id =
      '6cbcd000-0000-4000-8000-000000000002'::uuid)::text,
    count(*) FILTER (WHERE superseded_snapshot_id =
      '6cbca000-0000-4000-8000-000000000001'::uuid
      AND replacement_snapshot_id = '6cbca000-0000-4000-8000-000000000002'::uuid)::text
...
if [[ "${race_state}" != '1|1|0|1' ]]; then
  echo "current-city active head 并发 replacement 不变量失败：${race_state}" >&2
  exit 1
fi
...
replacement_ready_lock='6cb-concurrency-replacement-first-ready'
...
run_psql --quiet --command="
  ...
  SELECT app_private.declare_management_current_city_snapshot_replacement_v1(
    '6cbcd000-0000-4000-8000-000000000004'::uuid,
    '${replacement_user_one}'::uuid, '${replacement_project}'::uuid,
    '6cbca000-0000-4000-8000-000000000004'::uuid,
    '6cbca000-0000-4000-8000-000000000005'::uuid, 'contact_revision'
  );
...
if [[ "${replacement_first_status}" -ne 0 || "${replacement_revoke_status}" -ne 0 ]]; then
  echo "current-city replacement-first 锁顺序失败：replacement=${replacement_first_status}, revoke=${replacement_revoke_status}" >&2
...
replacement_first_state="$(run_psql --tuples-only --no-align --field-separator='|' --command="
  SELECT
    (SELECT count(*) FROM app_private.management_current_city_report_snapshot_replacements
      WHERE superseded_snapshot_id = '6cbca000-0000-4000-8000-000000000004'::uuid),
...
if [[ "${replacement_first_state}" != '1|1' ]]; then
  echo "current-city replacement-first 最终状态错误：${replacement_first_state}" >&2
  exit 1
fi
...
revoke_ready_lock='6cb-concurrency-revoke-first-ready'
...
run_psql --quiet --command="
  SELECT app_private.declare_management_current_city_snapshot_replacement_v1(
    '6cbcd000-0000-4000-8000-000000000006'::uuid,
    '${replacement_user_two}'::uuid, '${replacement_project}'::uuid,
    '6cbca000-0000-4000-8000-000000000006'::uuid,
    '6cbca000-0000-4000-8000-000000000007'::uuid, 'late_accepted_data'
  );
...
if [[ "${revoke_first_status}" -ne 0 || "${revoke_replacement_status}" -eq 0 ]]; then
  echo "current-city revoke-first 锁顺序失败：revoke=${revoke_first_status}, replacement=${revoke_replacement_status}" >&2
...
if ! grep -Eqi 'authorization forbidden|authorization.*denied|capability' "${revoke_replacement_output}"; then
  echo '撤权先提交后 current-city replacement 没有 fail closed。' >&2
  sed -n '1,160p' "${revoke_replacement_output}" >&2
  exit 1
fi
...
revoke_first_state="$(run_psql --tuples-only --no-align --field-separator='|' --command="
  SELECT
    (SELECT count(*) FROM app_private.management_current_city_report_snapshot_replacements
      WHERE superseded_snapshot_id = '6cbca000-0000-4000-8000-000000000006'::uuid),
    (SELECT CASE WHEN inactive_from_utc IS NULL THEN 0 ELSE 1 END
      FROM app_data.management_report_capability_grants
      WHERE capability_grant_id = '${replacement_capability_two}'::uuid);
" | tr -d '[:space:]')"
if [[ "${revoke_first_state}" != '0|1' ]]; then
  echo "current-city revoke-first 最终状态错误：${revoke_first_state}" >&2
  exit 1
fi

echo '为两个 actor 追加新的 synthetic capability，验证 release↔replacement request UUID 双向互斥。'
run_psql --quiet --command="
  INSERT INTO app_data.management_report_capability_grants (
    capability_grant_id, project_membership_id, capability_id,
    active_from_utc, inactive_from_utc
    ...
    (
      '6cbc6000-0000-4000-8000-000000000003'::uuid,
      '6cbc5000-0000-4000-8000-000000000002'::uuid,
      'release_management_reports', clock_timestamp(), NULL
    ),
    (
      '6cbc6000-0000-4000-8000-000000000004'::uuid,
      '6cbc5000-0000-4000-8000-000000000001'::uuid,
      'release_management_reports', clock_timestamp(), NULL
    );
"

release_claim_request='6cbcd000-0000-4000-8000-000000000008'
release_claim_lock="management-report-release-request:${release_claim_request}"
release_claim_ready='6cb-concurrency-release-claim-first-ready'
release_claim_first_output="${temporary_directory}/release-claim-first.out"
release_claim_replacement_output="${temporary_directory}/release-claim-replacement.out"

echo '验证 release-first：replacement 等待同一 request lock 后失败关闭。'
run_psql --quiet --command="
  BEGIN;
...
" >"${release_claim_first_output}" 2>&1 &
release_claim_first_pid=$!
wait_for_lock_holder \
  "${release_claim_ready}" "${release_claim_first_pid}" \
  "${release_claim_first_output}"
...
release_claim_first_status=0
release_claim_replacement_status=0
wait "${release_claim_first_pid}" || release_claim_first_status=$?
wait "${release_claim_replacement_pid}" || release_claim_replacement_status=$?
if [[ "${release_claim_first_status}" -ne 0 \
  || "${release_claim_replacement_status}" -eq 0 ]]; then
  echo "release-first request claim 互斥失败：release=${release_claim_first_status}, replacement=${release_claim_replacement_status}" >&2
  sed -n '1,160p' "${release_claim_first_output}" >&2
  sed -n '1,160p' "${release_claim_replacement_output}" >&2
  exit 1
fi
if ! grep -Eqi 'already used by another report contract|request id.*another' \
  "${release_claim_replacement_output}"; then
  echo 'release-first 的 replacement 没有因 family claim 失败。' >&2
  sed -n '1,160p' "${release_claim_replacement_output}" >&2
  exit 1
fi

release_claim_state="$(run_psql --tuples-only --no-align --field-separator='|' --command="
  SELECT claim.release_family_id,
    (SELECT count(*)
      FROM app_private.management_current_city_report_release_attempts
      WHERE release_request_id = '${release_claim_request}'::uuid),
    (SELECT count(*)
      FROM app_private.management_current_city_report_snapshot_replacements
      WHERE replacement_request_id = '${release_claim_request}'::uuid)
  FROM app_private.management_report_release_request_claims AS claim
  WHERE claim.release_request_id = '${release_claim_request}'::uuid;
" | tr -d '[:space:]')"
if [[ "${release_claim_state}" != \
  'current_city_management_report_snapshot_release|1|0' ]]; then
  echo "release-first request claim 最终状态错误：${release_claim_state}" >&2
  exit 1
fi

replacement_claim_request='6cbcd000-0000-4000-8000-000000000009'
replacement_claim_lock="management-report-release-request:${replacement_claim_request}"
replacement_claim_ready='6cb-concurrency-replacement-claim-first-ready'
replacement_claim_first_output="${temporary_directory}/replacement-claim-first.out"
replacement_claim_release_output="${temporary_directory}/replacement-claim-release.out"

echo '验证 replacement-first：release 等待同一 request lock 后失败关闭。'
run_psql --quiet --command="
  BEGIN;
  SELECT pg_advisory_xact_lock(
    hashtextextended('${replacement_claim_lock}', 0)
  );
  SELECT app_private.declare_management_current_city_snapshot_replacement_v1(
...
" >"${replacement_claim_first_output}" 2>&1 &
replacement_claim_first_pid=$!
wait_for_lock_holder \
  "${replacement_claim_ready}" "${replacement_claim_first_pid}" \
  "${replacement_claim_first_output}"
...
replacement_claim_first_status=0
replacement_claim_release_status=0
wait "${replacement_claim_first_pid}" || replacement_claim_first_status=$?
wait "${replacement_claim_release_pid}" || replacement_claim_release_status=$?
if [[ "${replacement_claim_first_status}" -ne 0 \
  || "${replacement_claim_release_status}" -eq 0 ]]; then
  echo "replacement-first request claim 互斥失败：replacement=${replacement_claim_first_status}, release=${replacement_claim_release_status}" >&2
  sed -n '1,160p' "${replacement_claim_first_output}" >&2
  sed -n '1,160p' "${replacement_claim_release_output}" >&2
  exit 1
fi
if ! grep -Eqi 'already used by another report contract|request id.*another' \
  "${replacement_claim_release_output}"; then
  echo 'replacement-first 的 release 没有因 family claim 失败。' >&2
  sed -n '1,160p' "${replacement_claim_release_output}" >&2
  exit 1
fi

replacement_claim_state="$(run_psql --tuples-only --no-align --field-separator='|' --command="
  SELECT claim.release_family_id,
    (SELECT count(*)
      FROM app_private.management_current_city_report_release_attempts
      WHERE release_request_id = '${replacement_claim_request}'::uuid),
    (SELECT count(*)
      FROM app_private.management_current_city_report_snapshot_replacements
      WHERE replacement_request_id = '${replacement_claim_request}'::uuid)
  FROM app_private.management_report_release_request_claims AS claim
  WHERE claim.release_request_id = '${replacement_claim_request}'::uuid;
" | tr -d '[:space:]')"
if [[ "${replacement_claim_state}" != \
  'current_city_management_report_snapshot_replacement|0|1' ]]; then
  echo "replacement-first request claim 最终状态错误：${replacement_claim_state}" >&2
  exit 1
fi

echo '6CB current-city replacement concurrency check passed: same-head, replacement/revocation and release/replacement request-claim ordering hold.'
