...
DO $management_consent_ratio_snapshot_release_writer_membership$
DECLARE
  member_name text;
BEGIN
  FOR member_name IN
  ...
  END LOOP;
END
$management_consent_ratio_snapshot_release_writer_membership$;

DO $management_deidentified_anomaly_reader_membership$
DECLARE
  member_name text;
BEGIN
  FOR member_name IN
  ...
  END LOOP;
END
$management_deidentified_anomaly_reader_membership$;
SQL
