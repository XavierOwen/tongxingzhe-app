...
# Wrappers must exec the actual client, or terminate and wait for that client
# and their children on TERM, without starting connections after exit.
# Remote transports and non-cooperative forks are unsupported.
...
VALUES (
  '6becd000-0000-4000-8000-000000000001'::uuid,
  '6bec4000-0000-4000-8000-000000000001'::uuid,
