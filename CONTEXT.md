...
**我的组织目录**:
当前 active 账号在读取时具有有效组织成员关系、且组织未删除的名称与标识列表；包含尚无项目的组织，不授予项目上下文、owner 或其他能力，也不是恢复期组织目录。
_Avoid_: 全 App 组织搜索、成员目录、项目切换列表、组织权限清单
...
**无下游关系成员自助退出**:
当前成员自行结束尚未安排结束、该成员关系没有项目成员历史、没有仍有效或未来有效所有权，也没有本组织未结束对象分配的组织成员关系；只结束这段成员关系，不代表递归撤销项目权限的完整组织退出。客户端退出时还须清除该组织在本设备的敏感缓存。
_Avoid_: 删除成员、退出登录、完整组织退出、撤销所有权限

**定向邀请**:
组织发给指定邮箱或用户账号的一次性入组凭证，有效期为七天；只有预定接收者接受后才建立成员关系。
当前账号邀请允许绑定收件人在入组前，按已知邀请 UUID 在线预览仍可接受邀请的组织名称与有效期；预览不等于加入或保留接受资格，也不开放组织搜索。
_Avoid_: 通用邀请码、永久链接
...
**组织待审批申请目录**:
组织当前所有者在一次一致读取中可见的最早二十条未过期待审批记录；它只提供申请编号、来源链接编号和时间，不识别申请人，也不证明现在可批准。待审批不额外排除已入组或失去账号资格的申请人，批准仍须重新验证。
_Avoid_: 完整申请队列、成员目录、申请人资料、批准资格证明
...
**普通项目成员安排**:
组织所有者明确把本组织已有有效成员安排到一个推广项目的治理行为；它只建立默认推广者成员关系，不授予管理能力、对象分配或个人资料访问权。所有者安排自己也须明确操作，不能由所有权自动推导。
_Avoid_: 自动加入全部项目、项目管理员授予、管理 capability 分配、推广对象分配
