...
保存的 v5 schema 只用于证明旧结构和升级起点，不代表现代领域模型。机器可读基线在 `drift_schemas/drift_schema_v5.json`，当前 v18 与升级过程见[第 3 章](03-contact-journal-and-local-sql.md)，完整盘点见 [Legacy Drift v5 盘点](../migrations/legacy-v5-inventory.md)。
...
Drift v5／v6／v8 到当前 v18 的 migration 测试：
