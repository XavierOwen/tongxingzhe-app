...
- **Blocking**: use GitHub native issue dependencies. Where dependencies are unavailable, use a `Blocked by: #<n>` line at the top of the issue body.
- **Frontier query**: select the first open child without an open blocker or assignee.
