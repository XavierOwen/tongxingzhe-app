...
完整 runner 自动发现 0080 migration、structural check、rollback fixture 和 replacement concurrency script，并在 checksum 与 dump／restore 后重跑 migration、check 和 fixture。恢复库不重跑会提交行的并发脚本。
